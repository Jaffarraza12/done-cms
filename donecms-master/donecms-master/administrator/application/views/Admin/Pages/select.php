                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <label class="radio line">
                                    <div class="radio" id="uniform-undefined">
                                        <span>
                                            <input type="radio" value="Activities" name="q" style="opacity: 0;">
                                        </span>
                                    </div>
                                    Activity
                                </label>
                                <label class="radio line">
                                    <div class="radio" id="uniform-undefined">
                                        <span>
                                            <input type="radio" value="Books" name="q" style="opacity: 0;">
                                        </span>
                                    </div>
                                    Book
                                </label>
                                <label class="radio line">
                                    <div class="radio" id="uniform-undefined">
                                        <span>
                                            <input type="radio" value="Abstracts" name="q" style="opacity: 0;">
                                        </span>
                                    </div>
                                    Abstracts
                                </label>
