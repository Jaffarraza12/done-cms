...
<head>
    <meta charset="utf-8" />
    <title>Arab Family | Login Page</title>
...
<div class="content">
    ...
    <form class="form-vertical login-form" action="<?php echo base_url(); ?>index.php/Admin/Login" method="POST">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-icon left">
                    <i class="icon-user"></i>
                    <input class="m-wrap placeholder-no-fix" type="text" placeholder="Username" name="txtUsername"/>
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-icon left">
                    <i class="icon-lock"></i>
                    <input class="m-wrap placeholder-no-fix" type="password" placeholder="Password" name="txtPassword"/>
                </div>
            </div>
        </div>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
    <?php echo date('Y') .' &copy; product of '.'<a style="color:#999" target="_blank" href="http://appertunity.net/">Appertunity</a>';?>
</div>
<!-- END COPYRIGHT -->
