            ...
            <?php if (strtolower($this->input->get('q')) == strtolower("Abstracts")) { ?>
                        ...
                        <div class="row-fluid">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    م<input id="txtYear" type="text" name="year_<?php echo $langCode; ?>" placeholder="Please enter Year" class="span4 m-wrap popovers" data-original-title="Year" data-content="Please Enter Year" data-trigger="hover" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="multi_pdf_<?php echo $langCode; ?>" class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <button type="button" class="btn pull-right" onclick="deletePDF()">X</button>
                                </div>
                            </div>
                        ...
                        <div id="multi_pdf_2<?php echo $langCode; ?>" class="row-fluid">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <button type="button" class="btn pull-right" onclick="deletePDF2()">X</button>
                                </div>
                            </div>
