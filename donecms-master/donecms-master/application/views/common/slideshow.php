    ...
    <div id="slider1" class="rev_slider"  data-version="5.0">
        <ul>
            ...
            <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="images/bg/2.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?php echo base_url(); ?>/uploads/slideshow/<?php echo $slide->image ?>"  alt=""  data-bgposition="100% 90%" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
                <div class="hidden  tp-caption tp-resizeme rs-parallaxlevel-0 text-uppercase"
                     id="rs-1-layer-1"
                     ...
                     style="z-index: 6; letter-spacing:-3px; white-space: nowrap;"><span class="text-thm hidden">Lorem  </span><span class="text-white">Ipsum  </span>
                </div>
                <!-- LAYER NR. 2 -->
                <div class="hidden tp-caption BigBold-SubTitle tp-resizeme rs-parallaxlevel-0"
                     id="rs-1-layer-2"
                     ...
                     data-basealign="slide"
                     data-responsive_offset="on"
                     style="z-index: 7;"><span class="text-white text-white-cap hidden">أبجد هوز dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
                </div>
                <!-- LAYER NR. 3 -->
                <div class="hidden  tp-caption btn btn-default btn-lg thm-btn pl-40 pr-40 rs-parallaxlevel-0"
                ...
                <!-- LAYER NR. 4 -->
                <div class="hidden tp-caption btn btn-default btn-lg thm-btn inverse pl-40 pr-40 rs-parallaxlevel-0"
